...
const gamesURL="https://ga6b34a521bd0e6-db202109301832.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/games/games";
const clientURl="https://ga6b34a521bd0e6-db202109301832.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/client/client";
const messageURL="https://ga6b34a521bd0e6-db202109301832.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/message/message";
function traerInformacionGames(){
    $.ajax({
        url:gamesURL, //colocar la http del modulo de la tabla GAMES
        type:"GET",
        datatype:"JSON",
...
function traerInformacionClient(){
    $.ajax({
        url:clientURl, //colocar la http del modulo de la tabla CLIENT
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function traerInformacionMessage(){
    $.ajax({
        url:messageURL,  //colocar la http del modulo de la tabla MESSAGE
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
